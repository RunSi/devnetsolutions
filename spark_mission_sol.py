...
ACCESS_TOKEN 	= "ZDM5NWZkNjktNzBlYy00ZjdmLWJhNjAtNjJlYTA0NWQwMjdlMGY3OTM2ZGItODJj" #Replace None with your access token. Shroud with quotes.
ROOM_NAME		= "TEST" #Replace None with the name of the room to be created. Shroud with quotes.
YOUR_MESSAGE 	= "The Solution" #Replace None with the message that you will post to the room. Shroud with quotes.
